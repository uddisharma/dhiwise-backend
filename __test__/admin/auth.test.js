...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Brain.DAmore84',
      password: 'g8I9D2NWYju0_lT',
      email: 'Cristobal_Welch@gmail.com',
      name: 'Alexander Beier',
      shippingAddress: [
        {
          _id: false,
          pincode: 'feed',
      ...
      userType: 256,
      mobileNo: '(982) 475-3191',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 156,
      loginReactiveTime: '2024-06-28T20:58:50.569Z',
      id: '65eeb155d06cb70305a5a955'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Griffin_Yost33',
        'password':'Q2lo4d8sQ0UTAnZ',
        'email':'Ed.Volkman46@gmail.com',
        'name':'Alberto Brekke',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Grocery',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Ed.Volkman46@gmail.com', });
